...
macro(rexglue_setup_target target_name)
    if(REXGLUE_ENTRYPOINT_GENERATED_SOURCES)
        ...
        rexglue_apply_recomp_settings(${target_name}_recomp
            "${REXGLUE_ENTRYPOINT_INCLUDE_DIR}/nba_live_10_pch.h")
        add_dependencies(${target_name}_recomp nba_live_10_codegen)
        target_link_libraries(${target_name} PRIVATE
            ${target_name}_recomp)
    endif()
    # Also on the host, so a tree that has never run codegen still generates it.
    add_dependencies(${target_name} nba_live_10_codegen)
...
# changes. Build it alone with 'cmake --build . --target nba_live_10_codegen'.
...
add_custom_command(
    ...
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/nba_live_10_manifest.toml
    DEPFILE "${CMAKE_CURRENT_SOURCE_DIR}/generated/default/codegen.d"
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for nba_live_10"
    VERBATIM
)
add_custom_target(nba_live_10_codegen
