...
set(LIVE_RECOMP_ROOT "${CMAKE_CURRENT_LIST_DIR}/.." CACHE INTERNAL "")

if(NOT TARGET live_common)
    add_subdirectory("${LIVE_RECOMP_ROOT}/common" "${CMAKE_BINARY_DIR}/live_common")
endif()

function(live_recomp_add_game target)
    ...
    target_link_libraries(${target} PRIVATE live::common)

    if(GAME_DEVELOPMENT_GAME_ROOT)
        target_compile_definitions(${target} PRIVATE
            LIVE_DEVELOPMENT_GAME_ROOT="${GAME_DEVELOPMENT_GAME_ROOT}")
    endif()
