...
#include "live/installer/content_package_installer.h"
...
constexpr const char* kContentPackageVariable = "LIVE_RECOMP_INSTALL_DLC";
...
void LiveRecompApp::InstallContentPackages() {
